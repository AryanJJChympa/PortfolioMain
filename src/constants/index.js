...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "Built ChatLy, a real-time MERN stack chat application leveraging WebSockets for instant messaging, featuring user-friendly UI, responsive design, and seamless communication—demonstrating expertise in full-stack development and socket integration.",
    technologies: ["React", "Tailwind", "NodeJs", "MongoDB", "Web Sockets"],
    links: ["https://chatly-fullstack-chatapp.onrender.com/"],
  },
  {
    title: "NoteFlow",
    image: project2,
    description:
      "Developed NoteFlow, a personal MERN stack note-taking app featuring CRUD operations, clean UI, and local usage optimization—my first full-stack project showcasing core React, Express, and MongoDB integration.",
    technologies: ["React", "Tailwind", "NodeJs", "MongoDB"],
    links: ["https://noteflow-t4zv.onrender.com/"],
  },
  {
    title: "EchorTrip",
    image: project3,
